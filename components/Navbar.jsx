      ...
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <div>
          <ul style={{color: `${linkColor}`}} className="hidden md:flex">
            ...
            <Link href="/#about">
              <li className="ml-10 text-sm uppercase hover:border-b">Om</li>
            </Link>
            <Link href="/#skills">
        ...
        <div
          className={
            nav
              ...
              : "fixed left-[-500%] top-0 p-10 ease-in duration-300"
          }
        >
          <div>
          ...
          <div className="py-4 flex flex-col">
            <ul className="uppercase">
              ...
              <Link onClick={handleNav} href="/#about">
                <li className="py-4 text-sm">Om</li>
              </Link>
              <Link onClick={handleNav} href="/#skills">
                <li className="py-4 text-sm">Ferdigheter</li>
              </Link>
              <Link onClick={handleNav} href="/#projects">
                <li className="py-4 text-sm">Prosjekter</li>
              </Link>
              <Link onClick={handleNav} href="/#contact">
                <li className="py-4 text-sm">Kontakt meg</li>
              </Link>
            </ul>
            <div className="pt-40">
