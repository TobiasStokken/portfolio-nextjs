    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <a href="https://drive.google.com/file/d/1HS719Y48x6HqI3GY65kh_Y0uEAA3fLX5/view?usp=share_link">
            <button className="px-8 py-2 mt-4 mr-8">Last ned og Prøv!</button>
          </a>
        </div>
